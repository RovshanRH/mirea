        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                case '5':
                    ...
                    Console.WriteLine("Введите id стола: ");
                    string tableIdToChange = Console.ReadLine();
                    Console.WriteLine("Введите новое расположение стола: ");
                    string newPlacement = Console.ReadLine();
                    Console.WriteLine("Введите новое количество мест: ");
                    int newSeatsNumber = int.Parse(Console.ReadLine());
                    Table.changeInfoTable(tableIdToChange, newPlacement, newSeatsNumber);
                    break;
                case '6':
                    Console.WriteLine("Введите id стола: ");
